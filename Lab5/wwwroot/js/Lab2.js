...
function addCountry() {
    ...
    const country = {
        value: addNameTextbox.value.trim(),
    };
...
function displayEditForm(id) {
    ...
    document.getElementById('edit-name').value = country.value;
...
function updateCountry() {
    ...
    const country = {
        ...
        value: document.getElementById('edit-name').value.trim()
    };
...
function _displayCountries(data) {
    ...
    data.forEach(country => {
        ...
        let textNode = document.createTextNode(country.value);
